          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span>Griblje 63A, 8332 Gradac</span>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-4 h-4 mt-0.5 text-gray-400 flex-shrink-0" aria-hidden="true" />
                <a href="tel:041276195" className="hover:text-white transition-colors">041 276 195</a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-4 h-4 mt-0.5 text-gray-400 flex-shrink-0" aria-hidden="true" />
                <a href="mailto:lesne.storitve@gmail.com" className="hover:text-white transition-colors">lesne.storitve@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-300 text-sm">
              &copy; {new Date().getFullYear()} Ograje Lozar. Vse pravice pridržane.
            </p>
            <div className="flex items-center gap-2 text-sm text-gray-400">
              <span>Made with</span>
              <Heart className="w-4 h-4 text-red-500" aria-hidden="true" />
              <span>in Slovenija</span>
            </div>
          </div>
        </div>
      </div>
